/**
 * The one-line "read" for each office — the verdict an executive wants before
 * the tiles. Grounded in each persona's own KPIs and insights (§8.1a); a
 * synthesis across their governed facts, never a fabricated figure.
 */
